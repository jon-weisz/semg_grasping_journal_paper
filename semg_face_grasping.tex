...
\begin{figure}
\centering
\includegraphics[width=.45\columnwidth,trim={30cm 40cm 20cm 20cm},clip=true]{user_semg_2.jpg}
...
\begin{figure}
\includegraphics[width=.5\columnwidth]{images_4/semg_clutter_grasp.png}
